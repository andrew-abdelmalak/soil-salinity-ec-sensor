#!/usr/bin/env python3
# Script to create noise_compensation_main.m with proper line endings
...
fprintf('Config: Duration=%.1f s, SNR=%.0f dB, Drift=%.1f%%\n\n', T_total, SNR_dB, drift_amp*100);

%% Generate True Signals
fprintf('STEP 1: Generating True EC Trajectory...\n');
...
EC_raw = interp1(I_true, EC_true, I_meas, 'linear', 'extrap');
fprintf('\n');

%% Apply Compensation
fprintf('STEP 3: Applying Compensation Filter...\n');
...
EC_est = interp1(I_true, EC_true, I_comp, 'linear', 'extrap');
fprintf('\n');
...
# Write to repo path with Windows line endings
