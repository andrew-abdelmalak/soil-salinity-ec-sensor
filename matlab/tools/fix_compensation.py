...
code = r'''function [I_comp, EC_est, I_filt, b_est] = ms3_compensation_filter(I_meas, t_vec, filter_params)
...
output_path = r'd:\My Mine\Semester 9\Sensor Technology\Antigravity\Project\MATLAB\ms3_compensation_filter.m'
with open(output_path, 'w', newline='\r\n', encoding='utf-8') as f:
    f.write(code)

print("Fixed compensation filter")
