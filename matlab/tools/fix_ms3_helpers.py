#!/usr/bin/env python3
# Script to fix all MS3 helper functions with proper line endings

import os

# Directory
matlab_dir = r'd:\My Mine\Semester 9\Sensor Technology\Antigravity\Project\MATLAB'

# ===== ms3_add_noise_and_drift.m =====
noise_drift_code = r'''function [I_meas, n_t, b_t] = ms3_add_noise_and_drift(I_true, t_vec, SNR_dB, drift_amp, drift_freq)
% MS3: Add noise and drift to ideal sensor output
...
# ===== ms3_compensation_filter.m =====
comp_filter_code = r'''function [I_comp, EC_est, I_filt, b_est] = ms3_compensation_filter(I_meas, t_vec, filter_params)
% MS3: Apply compensation filter (noise reduction + drift removal)
...
# ===== ms3_error_metrics.m =====
error_metrics_code = r'''function [metrics, summary_str] = ms3_error_metrics(EC_true, EC_raw, EC_est, t_vec)
% MS3: Compute error metrics and performance evaluation
...
# ===== ms3_generate_signals.m =====
gen_signals_code = r'''function [EC_true, R_soil_true, I_true] = ms3_generate_signals(t_vec, params)
% MS3: Generate true EC trajectory and ideal sensor output
...
# Write all files
files = {
    'ms3_add_noise_and_drift.m': noise_drift_code,
    'ms3_compensation_filter.m': comp_filter_code,
    'ms3_error_metrics.m': error_metrics_code,
    'ms3_generate_signals.m': gen_signals_code
}
...
print("\nAll MS3 helper functions created successfully!")
